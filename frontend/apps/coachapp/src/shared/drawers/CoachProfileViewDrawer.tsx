      ...
      <Modal>
        ...
        >
          ...
          >
            <Modal.Dialog>
              <Modal.Header>
                <Modal.Heading className="text-xl font-semibold">My Profile</Modal.Heading>
              </Modal.Header>
              <Modal.Body>
      ...
      <Section title="Coach Profile">
        ...
        {coach.bio ? (
          <div className="flex flex-col gap-1 mt-3">
            ...
            <p className="text-sm text-foreground whitespace-pre-wrap">{coach.bio}</p>
          </div>
        ) : (
...
const Section: FC<{title: string; children: React.ReactNode}> = ({title, children}) => (
  <div className="flex flex-col gap-3">
    <p className="text-xs font-semibold uppercase tracking-wide text-default-400">{title}</p>
    {children}
  </div>
);
...
const EmptyState: FC<{text: string}> = ({text}) => <p className="text-sm italic text-default-400">{text}</p>;
