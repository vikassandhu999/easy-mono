...
export const AuthAPI = {
    ...
    completeProfile: async (data: CompleteProfileRequest): Promise<Result<{client: ApiClient; message: string}>> => {
        try {
    ...
    sendClientInvitationOTP: async (data: SendClientInvitationOTPRequest): Promise<Result<LoginResponse>> => {
        try {
    ...
    verifyClientInvitationOTP: async (data: VerifyClientInvitationOTPRequest): Promise<Result<AccessTokenResponse>> => {
        try {
    ...
    sendClientPhoneLoginOTP: async (data: SendClientPhoneLoginOTPRequest): Promise<Result<LoginResponse>> => {
        try {
    ...
    verifyClientPhoneLoginOTP: async (data: VerifyClientPhoneLoginOTPRequest): Promise<Result<AccessTokenResponse>> => {
        try {
