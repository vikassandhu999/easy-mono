          ...
          <h1 style={previewStyles.heroHeadline}>
            {headline ? (
              <>
                ...
                <span style={previewStyles.heroAccent}>{headline.split(' ').slice(2).join(' ') || 'LIVE BETTER'}</span>
              </>
            ) : (
              <>
            ...
            {services.length > 0 ? (
              ...
              <>
                ...
                <div style={previewStyles.serviceCard}>
                  ...
                  <p style={previewStyles.serviceDesc}>Fully equipped with top-of-the-line tools and training areas.</p>
                  <button style={previewStyles.ctaButton}>RESERVE YOUR SPOT</button>
                </div>
              </>
            )}
