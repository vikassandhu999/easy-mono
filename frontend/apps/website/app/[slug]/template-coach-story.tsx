        ...
        <div style={{maxWidth: 1000, margin: '0 auto', display: 'grid', gridTemplateColumns: page.hero_image_url ? '1fr 1fr' : '1fr', gap: 80, alignItems: 'center'}}>
          ...
          <div>
            ...
            <button
              ...
              style={{background: C.olive, color: '#fff', fontSize: 14, fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', padding: '15px 32px', border: 'none', borderRadius: 6, cursor: 'pointer'}}
              type="button"
            >
              Work with me
            </button>
