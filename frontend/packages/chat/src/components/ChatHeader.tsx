...
import {ActionIcon, Text, Group, Title, Avatar} from '@mantine/core';
...
const ChatHeader = ({headerRef}: {headerRef: RefCallback<HTMLElement>}) => {
    ...
    if (!context) {
        // Handle case where context is not yet available, perhaps return null or a loading state
        // This might happen if ChatProvider is still loading the chat data
        return null;
    }
