...
import {ActionIcon, Badge, Button, Divider, Group, Loader, Stack, Text, Title} from '@mantine/core';
...
const ExerciseViewDrawer = () => {
    ...
    const handleDuplicate = async () => {
        ...
        try {
            const duplicatedExercise = await duplicateExercise({id: exerciseId}).unwrap();
            notifySuccess('Exercise duplicated. Now you can edit it.');
