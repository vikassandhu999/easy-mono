...
// Only Create Persisted wheen state need to be in peristed way
const persistConfig = {
...
export const planLabelsReducerPersisted = persistReducer(persistConfig, planLabelsSlice.reducer);
