...
config :easy, :email,
  from_email: {
    System.get_env("EMAIL_FROM_NAME") || "Coach Easy",
    System.get_env("EMAIL_FROM_ADDRESS") || "noreply@coacheasy.app"
  },
  app_url: System.get_env("APP_URL") || "http://localhost:4000"
...
#
#     PHX_SERVER=true bin/easy start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :easy, EasyWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  # Governs EasyWeb.Cors.origins/0. Empty (unset CORS_ALLOWED_ORIGINS) falls back to
  # permissive "*" so a missing env never blocks the frontends.
  config :easy, cors_origins: cors_origins
