...
import {useAssignNutritionPlanMutation, useListNutritionPlansQuery} from '@/api/nutritionPlans';
import {handleFormError} from '@/api/shared';
import {useAssignTrainingPlanMutation, useListTrainingPlansQuery} from '@/api/trainingPlans';
