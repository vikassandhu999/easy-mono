defmodule EasyWeb.Coaches.MealItemControllerTest do
  ...
  describe "POST /v1/coach/meals/:meal_id/items" do
    test "creates a meal item", %{conn: conn, coach: coach, business: business} do
      ...
      conn = post(conn, "/v1/coach/meals/#{meal.id}/items", attrs)
  ...
  describe "GET /v1/coach/meals/:meal_id/items" do
    test "lists meal items", %{conn: conn, coach: coach, business: business} do
      plan = insert(:plan, creator: coach, business: business)
      meal = insert(:meal, creator: coach, plan: plan, business: business)
      food = insert(:food, creator: coach, business: business)
      insert(:meal_item, meal: meal, food: food, business: business)

      conn = get(conn, "/v1/coach/meals/#{meal.id}/items")
  ...
  describe "PATCH /v1/coach/meal_items/:id" do
    test "updates a meal item", %{conn: conn, coach: coach, business: business} do
      ...
      conn = patch(conn, "/v1/coach/meal_items/#{meal_item.id}", %{"amount" => 2.0})
      assert %{"data" => data} = json_response(conn, 200)
  ...
  describe "DELETE /v1/coach/meal_items/:id" do
    test "deletes a meal item", %{conn: conn, coach: coach, business: business} do
      ...
      conn = delete(conn, "/v1/coach/meal_items/#{meal_item.id}")
