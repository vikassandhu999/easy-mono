...
import {Title, Text, Card, Group, Center, Box, Stack, ActionIcon} from '@mantine/core';
import {useNavigate} from 'react-router';
import {CaretRightIcon} from '@phosphor-icons/react';
import {CONTENT_TYPES} from '@/api/contents.ts';
...
export default function LibraryPage() {
    ...
    return (
        <PagePaper>
            <HeadingContainer
                withBorder={false}
                style={{paddingInline: 'var(--ce-size-lg)', paddingBlock: 'var(--ce-size-sm)'}}
            >
                <Stack
                    gap="xs"
                    style={{flex: 1}}
