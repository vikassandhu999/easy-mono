...
import {type AttachmentUploadRequest, useCreateClientUploadMutation} from '@/api/uploads';
...
export default function AttachmentComposer({disabled, onChange}: AttachmentComposerProps) {
  const inputId = useId();
