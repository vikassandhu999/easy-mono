...
import {Text, Button, Stack, Group, Chip, ScrollArea, Loader, Alert, Box, Card, Drawer} from '@mantine/core';
...
// PaddingContainer import removed as it's unused
...
export const TagsPicker: React.FC<TagsPickerProps> = ({opened, onClose, value, onChange, contentType}) => {
                ...
                <Box style={{flex: 1, minHeight: 0}}>
                    ...
                    {!contentType && (
                        <Box p="sm">
                            ...
                            >
                                <Text size="sm">Select a content type first to see available tags.</Text>
                            </Alert>
                        </Box>
                    )}
                    ...
                    {/* No tags available */}
                    {!isLoading && contentType && tagGroups.length === 0 && tagGroupsResult && (
                        <Box p="sm">
                            <Alert
                                variant="light"
                                color="gray"
