...
```tsx
import { ListPageLayout } from "@/shared/layouts";
...
```tsx
import { DetailPageLayout } from "@/shared/layouts";
...
```tsx
import { FormPageLayout } from "@/shared/layouts";
...
```tsx
import { PrimaryButton } from "@/shared/layouts";
...
```tsx
import { SecondaryButton } from "@/shared/layouts";
...
```tsx
import { DangerButton } from "@/shared/layouts";
...
```tsx
import { GhostButton } from "@/shared/layouts";
...
```tsx
import { ResponsiveCard } from "@/shared/layouts";
...
```tsx
import { SearchAndFilter } from '@/shared/layouts';
