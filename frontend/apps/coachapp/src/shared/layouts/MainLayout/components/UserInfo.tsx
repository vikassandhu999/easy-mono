  ...
  return (
    <Box p="md">
      <Menu position="top-end">
        ...
        <Menu.Dropdown>
          <Menu.Item leftSection={<IconUser style={{height: rem(16), width: rem(16)}} />}>My Profile</Menu.Item>
          <Menu.Item leftSection={<IconPaint style={{height: rem(16), width: rem(16)}} />}>Preferences</Menu.Item>
          <Menu.Item
            color="red"
