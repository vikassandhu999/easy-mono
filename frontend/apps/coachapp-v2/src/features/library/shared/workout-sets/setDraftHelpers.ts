import type {PlannedSet} from '@/entities/trainingPlans/api/trainingPlans';
...
export const newSetDraft = (): SetDraft => ({
  ...EMPTY_SET_TEMPLATE,
  localId: generateId(),
});

export const cloneSetDraft = (draft: SetDraft): SetDraft => ({
  ...draft,
  localId: generateId(),
});
