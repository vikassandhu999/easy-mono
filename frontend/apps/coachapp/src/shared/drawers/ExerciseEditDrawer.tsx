...
const ExerciseEditDrawer = () => {
  ...
  const { data: exercise, isLoading: isLoadingExercise } = useGetExercise(
    exerciseId ?? "",
    {
      skip: !exerciseId,
    },
        ...
        content={
          <Stack align="center" gap="md" p="xl">
            ...
            <Text c="dimmed" size="sm" ta="center">
              System exercises are read-only. You can duplicate this exercise to
              create your own customizable copy.
            </Text>
          </Stack>
        }
        onClose={closeDrawer}
