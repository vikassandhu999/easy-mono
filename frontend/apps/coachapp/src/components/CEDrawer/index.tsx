...
export const Index = factory<DrawerFactory>((_props, ref) => {
...
Index.displayName = '@mantine/core/Index';
Index.Root = DrawerRoot;
Index.Overlay = DrawerOverlay;
Index.Content = DrawerContent;
Index.Body = DrawerBody;
Index.Header = DrawerHeader;
Index.Title = DrawerTitle;
Index.CloseButton = DrawerCloseButton;
Index.Stack = DrawerStack;
