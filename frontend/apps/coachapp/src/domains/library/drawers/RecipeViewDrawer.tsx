import {Badge, Box, Button, Divider, Group, Loader, Paper, Stack, Table, Text, Title} from '@mantine/core';
import {IconClock, IconCopy, IconPencil, IconUsers} from '@tabler/icons-react';
...
const RecipeViewDrawer = () => {
    const {openDrawer, closeDrawer, getDrawerParams} = useLibraryDrawer();
        ...
        <AutoDrawer
            ...
            content={
                <Stack gap="lg">
                    ...
                    <Box>
                        <Badge
                            color={recipe.status === 'active' ? 'green' : recipe.status === 'draft' ? 'gray' : 'red'}
                            variant="light"
                        >
                            {recipe.status}
                        </Badge>
