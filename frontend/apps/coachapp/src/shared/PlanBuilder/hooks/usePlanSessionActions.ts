...
export function usePlanSessionActions({
    ...
    const handleCreatePlanSession = useCallback(
        async (payload: CreatePlanSessionInput, sessionType?: 'meal' | 'workout') => {
            try {
                ...
                notifications.show({
                    color: 'red',
                    message: error instanceof Error ? error.message : 'Failed to add session',
                    title: 'Error',
                });
                return false;
            }
    ...
    const handleDeletePlanSession = useCallback(
        async (planSessionId: string) => {
            try {
                ...
                notifications.show({
                    color: 'red',
                    message: error instanceof Error ? error.message : 'Failed to remove session',
                    title: 'Error',
                });
                return false;
            }
