...
import {
  BusinessCreateForm_zod,
  type BusinessCreateFormValues,
} from "@/services/business/business_definition";
...
const BusinessStep: React.FC<BusinessStepProps> = ({ onComplete }) => {
  ...
  const { control, handleSubmit, formState, watch, setValue } =
    useForm<BusinessCreateFormValues>({
      defaultValues: {
        name: "",
        handle: "",
        about: "",
    ...
    <form className="flex flex-col gap-6" onSubmit={handleSubmit(onSubmit)}>
      <div className="rounded-lg border border-neutral-200 bg-white p-6">
        ...
        <p className="mb-6 text-sm text-neutral-500">
          This is how clients will find and recognize you.
        </p>
            ...
            render={({ field, fieldState }) => (
              <TextField {...field} isInvalid={fieldState.invalid} isRequired>
                ...
                <p className="mt-1 text-xs text-neutral-400">
                  Lowercase letters, numbers, and underscores only. This will be
