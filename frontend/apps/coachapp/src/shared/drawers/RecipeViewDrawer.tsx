    ...
    <AutoDrawer
      ...
      content={
        <div className={classes.errorContainer}>
          <IconAlertCircle className={classes.errorIcon} size={48} />
            ...
            <div className={classes.section}>
              ...
              {hasNutrition ? (
                <div className={classes.nutritionGrid}>
                  {recipe.total_calories && (
                    <div
                      className={`${classes.nutritionCard} ${classes.nutritionCardCalories}`}
                    >
              ...
              recipe.instructions.length > 0 ? (
                <div className={classes.instructionsList}>
                  {recipe.instructions.map((instruction, index) => (
                    <div className={classes.instructionItem} key={index}>
                ...
                <p className={classes.instructionsPlainText}>
                  {recipe.instructions_as_text}
                </p>
              ) : (
                <div className={classes.emptyState}>
