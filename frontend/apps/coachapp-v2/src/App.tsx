  ...
  return (
    <Routes>
      ...
      <Route element={<AppShellScreen />}>
        ...
        <Route element={<ListRecipes />} path={ROUTES.RECIPES} />
        <Route element={<CreateRecipe />} path={ROUTES.CREATE_RECIPE} />
        <Route element={<RecipeDetail />} path={ROUTES.RECIPE_DETAIL} />
        <Route element={<EditRecipe />} path={ROUTES.EDIT_RECIPE} />
        <Route element={<ListNutritionPlans />} path={ROUTES.NUTRITION_PLANS} />
        <Route
