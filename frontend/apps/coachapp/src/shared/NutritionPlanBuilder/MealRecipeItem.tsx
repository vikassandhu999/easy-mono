    ...
    >
      <div className={classes.servingModal}>
        ...
        <div className={classes.servingModalHeader}>
          ...
          <Text className={classes.servingModalSubtitle}>
            Adjust portion size
          </Text>
        </div>
        ...
        <div className={classes.servingStepperSection}>
          ...
          <div className={classes.servingStepperValue}>
            ...
            <span className={classes.servingStepperLabel}>
        ...
        <div className={classes.servingModalActions}>
          ...
          <Button
            ...
            size="md"
          >
            {isSaving ? <Loader color="white" size="xs" /> : "Done"}
          </Button>
        </div>
      </div>
    </Modal>
...
export const MealRecipeItem = ({
  ...
  const servings =
    typeof item.servings === "string"
      ? parseFloat(item.servings)
      : item.servings;
