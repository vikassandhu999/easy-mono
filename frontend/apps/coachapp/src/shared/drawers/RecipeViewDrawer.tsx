          ...
          <div className={classes.container}>
                ...
                <div className={classes.ingredientsList}>
                  {recipe.recipe_ingredients.map((ingredient, index) => (
                    <div
                      ...
                      key={index}
                    >
                      <span className={classes.ingredientName}>{ingredient?.ingredient?.name || 'Unknown'}</span>
                      <span className={classes.ingredientQuantity}>{ingredient.quantity_as_text || '-'}</span>
                    </div>
                  ))}
                </div>
              ) : (
                <div className={classes.emptyState}>No ingredients added yet. Click Edit to add some.</div>
              )}
            </div>
            ...
            <div className={classes.section}>
              ...
              {hasNutrition ? (
                <div className={classes.nutritionGrid}>
                  ...
                  {recipe.total_carbohydrates && (
                    <div className={classes.nutritionCard}>
                      ...
                      <span className={classes.nutritionValue}>{recipe.total_carbohydrates}g</span>
                    </div>
                  )}
                  {recipe.total_fats && (
                    <div className={classes.nutritionCard}>
                ...
                <div className={classes.emptyState}>No nutrition info added yet. Click Edit to add some.</div>
              )}
            </div>
            ...
            <div className={classes.section}>
              ...
              {recipe.instructions && Array.isArray(recipe.instructions) && recipe.instructions.length > 0 ? (
                ...
                <div className={classes.emptyState}>No instructions added yet. Click Edit to add some.</div>
              )}
            </div>
          </div>
        }
