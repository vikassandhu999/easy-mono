...
const Features = () => {
  return (
    <section
      id="feature"
      className="px-4 md:px-0 w-full min-h-screen mx-auto font-sans py-20 md:py-32"
    >
      <main className="container mx-auto px-4 text-left ">
        ...
        <Link
          href={APP_LOGIN_URL}
          className="w-max flex gap-4 justify-between mx-auto items-center bg-blue-500 py-4 px-8 text-white font-semibold hover:bg-blue-600 transition-all hover:scale-105 shadow-lg"
        >
          Get Started
          <IconArrowRight />
        </Link>
