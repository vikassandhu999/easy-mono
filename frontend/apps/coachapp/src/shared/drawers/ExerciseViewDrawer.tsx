...
const ExerciseViewDrawer = () => {
  ...
  const handleDelete = () => {
    modals.openConfirmModal({
      ...
      children: <Text size="sm">Are you sure you want to delete this exercise? This action cannot be undone.</Text>,
        ...
        >
          ...
          {isSystem && (
            <Text
              ...
              size="xs"
            >
              Note : This is a system exercise and cannot be edited. Duplicate it to create your own customizable
              version.
            </Text>
          )}
        </Stack>
