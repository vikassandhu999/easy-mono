...
import {type AttachmentDownload, useGetClientAttachmentDownloadUrlsMutation} from '@/api/uploads';
...
export default function useAttachmentDownloadUrls(ids: string[]) {
  ...
  const [getDownloadUrls] = useGetClientAttachmentDownloadUrlsMutation();
