  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        description:
          'Your personal coaching platform for fitness and wellness goals. Track progress, connect with coaches, and achieve your health objectives.',
        dir: 'ltr',
        display: 'standalone',
        ...
        icons: [
          // Standard Android/Chrome PWA icons
          {
        ...
        shortcuts: [
          {
            description: 'View and manage your coaching programs',
            icons: [
              {
                sizes: '192x192',
                src: '/android-chrome-192x192.png',
